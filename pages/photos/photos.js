...
const /** {NodeElement} */ $filterWrappers = document.querySelectorAll("[data-filter]");
...
const /** {String} */ title = searchObj ? `نتائج البحث عن ${searchObj.query}` : "جميع الصور"
...
const renderPhotos = function (currentPage) {
    client.photos[searchObj ? "search" : "curated"]({ ...searchObj, per_page: perPage, page: currentPage }, data => {
        ...
        // when on more photo found, hide loader
